...
with open("./mv/refer_list0.txt", "rb") as get_myprofile:
    r0l = pickle.load(get_myprofile)
with open("./mv/refer_list1.txt", "rb") as get_myprofile:
    r1l=pickle.load(get_myprofile)
with open("./mv/all_mv.txt", "rb") as get_myprofile:
